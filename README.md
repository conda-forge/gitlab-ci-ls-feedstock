...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gitlab-ci-ls-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gitlab-ci-ls-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gitlab-ci-ls
# for installing globally
pixi global install gitlab-ci-ls
```
...
It is possible to list all of the versions of `gitlab-ci-ls` available on your platform:
...
```
pixi search gitlab-ci-ls --channel conda-forge
```
